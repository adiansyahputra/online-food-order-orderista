...
<section class="food-search2">
    <div class="container">
        ...
        if (isset($_POST['submit'])) {
            ...
            $result = preg_replace("/pm/", "", $order_date); //Order DAte
            ...
            $number_order = substr(md5(time()), 0, 16);
            ...
            if ($res2 == true) {
                ...
                $_SESSION['order'] = "<div class='success text-center'>Food Ordered Success. Your Number Order is $number_order. You can contact admin for further information and payment by sending your Number Order. Thankyou!</div>";
                header('location:' . SITEURL);
            } else {
